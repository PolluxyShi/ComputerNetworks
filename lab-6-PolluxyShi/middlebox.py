    ...
    def handle_packet(self, recv: switchyard.llnetbase.ReceivedPacket):
        ...
        if fromIface == "middlebox-eth0":
            ...
            if random() < self.dropRate:
                return
            packet[0] = Ethernet(src="40:00:00:00:00:02",dst="20:00:00:00:00:01",ethertype=EtherType.IPv4)
            ...
            '''
            packet[0] = Ethernet(src="40:00:00:00:00:01",dst="10:00:00:00:00:01",ethertype=EtherType.IPv4)
